...
import { Card, CardItem, Body, Container, Header, Content,   Title, Icon, Right, Left, Button } from 'native-base';
...
export default class ExampleView extends Component {
  ...
  _renderHeader(section, i, isActive) {
    return (
      <Animatable.View duration={400} style={[styles.header, isActive ? styles.active : styles.inactive]} transition="backgroundColor">
        <Text style={styles.headerText}>{section.ayat}</Text>
      </Animatable.View>
    );
  }
  ...
  render() {
    ...
    return (
            <Container>
        <Header>
          <Body style={{'flexDirection': 'row', 'justifyContent': 'center'}}><Title>Al Fatihah</Title></Body>
        </Header>
